...
import { BlackButton, Button, ButtonLike, Props, WhiteButton } from '../Button'
...
describe('BlackButton', () => {
  const renderButton = (props: Partial<Props>) => {
    return render(<BlackButton {...props} />)
  }
  ...
  it('accepts className', () => {
    ...
    const { getByRole } = renderButton({ className })
    const button = getByRole('button')
    expect(button.className).toEqual(`black-button ${className}`)
  })
})

describe('WhiteButton', () => {
  const renderButton = (props: Partial<Props>) => {
    return render(<WhiteButton {...props} />)
  }
  ...
  it('accepts className', () => {
    ...
    const { getByRole } = renderButton({ className })
    const button = getByRole('button')
    expect(button.className).toEqual(`white-button ${className}`)
  })
})
