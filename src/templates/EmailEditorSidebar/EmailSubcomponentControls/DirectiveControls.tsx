...
import { DirectiveVariant, useDirectiveValue } from 'src/templates/EmailTemplateSubComponents/Directive'
    ...
    <>
      ...
      <Select
        ...
        options={[
          ...
          { label: 'Three Steps w/ Step 2 Expansion', value: DirectiveVariant.StepTwoExpansion + '' },
